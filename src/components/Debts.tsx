...
import { Plus, Search, Calendar, ChevronRight, CheckCircle2, AlertCircle, Clock, MoreHorizontal } from 'lucide-react';
            ...
            >
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-[9px] font-bold text-slate-400 uppercase">{format(new Date(debt.createdAt), 'd MMM yyyy')}</p>
                </div>
              ...
              <div className="pt-2 flex items-center gap-2">
                {debt.status !== 'paid' ? (
                  ...
                  <div className="flex-1 bg-slate-50 text-slate-400 py-2 rounded-xl text-[10px] font-black uppercase text-center">
                    Telah Dibayar
                  </div>
                )}
                <button className="w-10 h-10 bg-slate-50 hover:bg-slate-100 text-slate-400 rounded-xl flex items-center justify-center transition-colors">
